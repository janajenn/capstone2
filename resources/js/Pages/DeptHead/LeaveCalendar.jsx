// resources/js/Pages/DeptHead/LeaveCalendar.jsx
...
// MonthAccordion Component - SAME AS ADMIN
...
export default function LeaveCalendar({ events, leavesByMonth, departmentName, leaveTypes, filters, currentYear }) {
    ...
    // Calculate pagination - SAME AS ADMIN
    ...
    // Calculate summary statistics - SAME AS ADMIN
    ...
    const applyFilters = () => {
        router.get(route('dept_head.leave-calendar'), localFilters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const clearFilters = () => {
        ...
        router.get(route('dept_head.leave-calendar'), {}, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    let title = `Leaves for ${localFilters.year} - ${departmentName}`;
        ...
        <DeptHeadLayout>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-bold text-gray-900">Leave Calendar - {departmentName}</h1>
                ...
                {/* Filters - SAME AS ADMIN (but no department filter) */}
                ...
                {/* Summary Cards - Only show in list view - SAME AS ADMIN */}
                {activeView === 'list' && (
                ...
                {/* Event Details Modal - SAME AS ADMIN */}
