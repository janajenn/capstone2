// resources/js/Pages/DeptHead/CreditConversions.jsx
import React, { useState, useEffect } from 'react';
import { Head, Link, router, usePage } from '@inertiajs/react';
import DeptHeadLayout from '@/Layouts/DeptHeadLayout';
import Swal from 'sweetalert2';

const CreditConversions = ({ conversions, departmentName, stats, filters }) => {
    ...
    const updateFilters = () => {
        router.get(route('dept_head.credit-conversions'), localFilters, {
            preserveState: true,
            replace: true
        });
    };
    ...
    const clearFilters = () => {
        ...
        router.get(route('dept_head.credit-conversions'), {}, {
            preserveState: true,
            replace: true
        });
    };
    ...
    const handleApprove = (conversion) => {
        Swal.fire({
            ...
            text: `Are you sure you want to approve ${conversion.employee_name}'s credit conversion request ?`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
                router.post(route('dept_head.credit-conversions.approve', conversion.conversion_id), {}, {
                    onSuccess: () => {
    ...
    const confirmReject = () => {
        ...
        router.post(route('dept_head.credit-conversions.reject', selectedConversion.conversion_id), {
    ...
    return (
        <DeptHeadLayout>
            <Head title="Credit Conversion Requests" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-gray-900">
                            Credit Conversion Requests - {departmentName}
                        </h1>
                        <p className="text-gray-600 mt-2">
                            Manage credit conversion requests from your team members
                        </p>
                    </div>

                    {/* UPDATED Stats Cards */}
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        {/* Pending Approval - Only HR approved requests waiting for Dept Head */}
                        ...
                        {/* Approved - Only those approved by this Dept Head */}
                        ...
                        {/* Rejected - Only those rejected by this Dept Head */}
                        ...
                        {/* Total Requests - All requests for this Dept Head's department */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="dept_head_approved">Dept Head Approved</option>
                                            ...
                                            <tr key={conversion.conversion_id} className="hover:bg-gray-50 transition-colors duration-200">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div className="flex items-center space-x-2">
                                                        <Link 
                                                            href={route('dept_head.credit-conversions.show', conversion.conversion_id)}
                                                            className="text-blue-600 hover:text-blue-900 transition-colors duration-200 font-medium"
                                                        >
                                                            View
                                                        </Link>
                                                        {conversion.status === 'hr_approved' && (
                                                            <>
                                                                <button 
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all duration-300 scale-100">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 text-center mb-2">
                            Approve Credit Conversion
                        </h3>
                        <p className="text-sm text-gray-600 text-center mb-6">
                            Are you sure you want to approve this credit conversion request?
                        </p>
                        ...
                        <div className="mb-6">
                            ...
                            <textarea 
                                ...
                                rows="3"
                                className="w-full border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300"
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            <button 
                                ...
                                className="px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium"
                            >
                                Approve Request
                            </button>
                        </div>
                    ...
                    {/* Reject Modal (Only for rejection with remarks) */}
                    {showRejectModal && (
                        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all duration-300 scale-100">
