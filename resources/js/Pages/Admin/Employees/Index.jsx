...
export default function EmployeesIndex({ employees, filters, pageTitle, totalCount, activeCount, inactiveCount }) {
    const [search, setSearch] = useState(filters.search || '');

    const handleSearch = (e) => {
        setSearch(e.target.value);
        router.get(route('admin.employees.index'), { search: e.target.value }, {
            preserveState: true,
            preserveScroll: true,
            replace: true
        });
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="ml-4">
                                                        ...
                                                        <div className="text-sm text-gray-500">
                                                            {employee.gender} • {new Date(employee.date_of_birth).toLocaleDateString()}
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
