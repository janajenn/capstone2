...
export default function ThemeEdit({ theme, auth }) {
    ...
    return (
        <HRLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Theme</h2>}
        >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <label htmlFor="is_active" className="ml-2 block text-sm text-gray-700">
                                                Activate this theme (will deactivate current active theme)
                                            </label>
                                        </div>

                                        <div className="text-sm text-gray-600">
                                            <p><strong>Created:</strong> {new Date(theme.created_at).toLocaleDateString()}</p>
                                            <p><strong>Last Updated:</strong> {new Date(theme.updated_at).toLocaleDateString()}</p>
                                            {theme.is_active && (
                                                <p className="text-green-600 font-medium">✓ Currently Active Theme</p>
                                            )}
                                        </div>
                                    </div>
