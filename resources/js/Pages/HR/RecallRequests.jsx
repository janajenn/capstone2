...
export default function RecallRequests() {
    const { recallRequests, flash } = usePage().props;
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Review and approve leave recall requests approved by department heads
                        </p>
                    </div>
                </div>
                                ...
                                {recallRequests.length === 0 ? (
                                    <tr>
                                        <td colSpan="7" className="px-6 py-4 text-center text-gray-500">
                                            No recall requests pending HR approval
                                        </td>
                                    </tr>
                                ) : (
                                    recallRequests.map((request) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                {request.approved_by_depthead ? (
                                                    <div>
                                                        <div className="font-medium">
                                                            {request.approved_by_depthead.name}
                                                        </div>
