...
import {
    ...
    ClockIcon,
    UserCircleIcon,
    UserIcon // Added UserIcon for profile
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="relative group">
                                    <button
                                        ...
                                        className="flex items-center justify-center p-2 rounded-full bg-gradient-to-br from-emerald-100 to-green-100 hover:from-emerald-200 hover:to-green-200 transition-all duration-300 group-hover:scale-105 group-hover:shadow-lg border border-emerald-200/50 hover:border-emerald-300"
                                        title="View Profile"
                                    ...
                                    >
                                        ...
                                        <div className="relative">
                                            <div className="w-8 h-8 flex items-center justify-center">
                                                {/* Option 2: UserCircleIcon */}
                                                <UserCircleIcon className="w-7 h-7 text-emerald-600 group-hover:text-emerald-700 transition-colors duration-300" />
                                            </div>
